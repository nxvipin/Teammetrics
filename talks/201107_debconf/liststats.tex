...
\begin{frame}
  \frametitle{Top 10 \link{http://lists.debian.org/debian-med}{debian-med@lists.debian.org}}
   \vspace{-5mm}
      ...
      \begin{center}
        \resizebox{125mm}{90mm}{\includegraphics{authorstat_med}}
      \end{center}
...
\begin{frame}
  \frametitle{Top 10 \link{http://lists.debian.org/debian-edu}{debian-edu@lists.debian.org}}
   \vspace{-5mm}
      ...
      \begin{center}
        \resizebox{125mm}{90mm}{\includegraphics{authorstat_edu}}
      \end{center}
...
\begin{frame}
  \frametitle{Top 10 \link{http://lists.debian.org/debian-jr}{debian-jr@lists.debian.org}}
   \vspace{-5mm}
      ...
      \begin{center}
        \resizebox{125mm}{90mm}{\includegraphics{authorstat_jr}}
      \end{center}
...
\begin{frame}
  \frametitle{Top 10 \link{http://lists.debian.org/debian-enterprise}{debian-enterprise@lists.debian.org}}
   \vspace{-5mm}
      ...
      \begin{center}
        \resizebox{125mm}{90mm}{\includegraphics{authorstat_enterprise}}
      \end{center}
